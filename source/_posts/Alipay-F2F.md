...
<!--more-->
开发之前还需要你一些准备，如账号注册，密钥绑定等，不了解流程的可以[看这里](https://arrietty.top/2019/04/01/Alipay-Prepare/)
...
以上纯属个人见解，如有错误欢迎指出
另外自己写了SpringBoot整合版，Swagger UI可供测试，代码地址[点这里](https://github.com/Arriettys/SprintBoot-pay)
